        ...
        ScrollView {
            VStack(alignment: .leading, spacing: 20) {
                ...
                privacySection(
                    ...
                    title: "No Cloud Sync",
                    description: "MemorySpark doesn't use iCloud or any cloud services. Your memories remain completely private."
                )
                
                privacySection(
                    icon: "person.slash.fill",
                    title: "No Accounts Required",
                    description: "You don't need to create an account or provide any personal information to use MemorySpark."
                )
                ...
                VStack(alignment: .leading, spacing: 12) {
                    ...
                    Text("MemorySpark only requests the following permissions:")
                        .font(.subheadline)
