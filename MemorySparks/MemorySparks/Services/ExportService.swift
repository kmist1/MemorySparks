...
class ExportService {
        ...
        DispatchQueue.global(qos: .userInitiated).async {
            do {
                ...
                let tempDir = FileManager.default.temporaryDirectory
                    .appendingPathComponent("MemorySparkExport-\(Date().timeIntervalSince1970)")
                ...
                let zipURL = FileManager.default.temporaryDirectory
                    .appendingPathComponent("MemorySpark-Export-\(Date().timeIntervalSince1970).zip")
    ...
    private func createReadme(memoryCount: Int) -> String {
        ...
        Privacy Note:
        ------------
        This export contains all your personal data from MemorySpark.
        Keep it secure and delete it when no longer needed.
        
        ---
        Generated by MemorySpark
