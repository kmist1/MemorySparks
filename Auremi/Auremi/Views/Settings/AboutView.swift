        ...
        ScrollView {
            VStack(spacing: 32) {
                ...
                VStack(alignment: .leading, spacing: 12) {
                    ...
                    Text("Auremi helps you capture and preserve life's small joys. One memory at a time, build a collection of moments that made you smile.")
                        .font(.body)
                        .foregroundColor(.secondary)
                ...
                VStack(spacing: 12) {
                    ...
                    Button(action: {
                        if let url = URL(string: "mailto:krunalmistry54@gmail.com") {
